...
public class UserServiceIT {
    ...
    void setUp() {
        ...
        existingTaskRequest = TaskUpdateRequest.builder()
                                               .id("task1")
                                               .title("Updated Title")
                                               .status(TaskStatus.COMPLETED)
                                               .build();
        newTaskRequest = TaskUpdateRequest.builder()
                                          .title("New Task")
        ...
        userUpdateRequest = UserUpdateRequest.builder().name("TestUpdate").email("user@update@gmail.com").password(
                "updated").roles(Set.of(RoleName.USER.name() , RoleName.ADMIN.name())).tasks(Set.of(existingTaskRequest , newTaskRequest)).build();
    }
    @Test
    @WithMockUser(username = "Test", authorities = {"USER_CREATE"})
