...
public class PermissionService {
    ...
    public PermissionResponse createPermission(PermissionRequest request) {
        ...
        if (permissionRepository.existsByName(request.getName())) throw new ApiException(ErrorCode.PERMISSION_ALREADY_EXISTS);
    ...
    public void deletePermissionByName(String permissionName) {
        ...
        if ( !permissionRepository.existsByName(permissionName)) throw new ApiException(ErrorCode.PERMISSION_NOT_FOUND);
