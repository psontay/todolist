...
public class UserServiceImpl implements UserService {
    ...
    @Override
    @Cacheable(cacheNames = "user-by-id",
            key = "#id")
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @Override
    @Cacheable(cacheNames = "user-by-email",
            key = "#email")
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @Override
    @Caching(evict = {
            @CacheEvict(cacheNames = "user-by-id",
                    key = "#id"),
            @CacheEvict(cacheNames = "user-list",
                    allEntries = true),
            @CacheEvict(cacheNames = "user-by-email",
                    allEntries = true),
            @CacheEvict(cacheNames = "user-by-keyword",
                    allEntries = true)
    })
    @Transactional
    @PreAuthorize("hasRole('ADMIN')")
    ...
    // advanced service
    @Override
    @CachePut(cacheNames = "user-by-id",
            key = "#id")
    @Transactional
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @Override
    @Cacheable(cacheNames = "user-by-keyword",
            key = "#keyword")
    @PreAuthorize("hasRole('ADMIN')")
