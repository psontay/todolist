...
public class AuthenticationController extends BaseController {
  ...
  public ResponseEntity<ApiResponse<RefreshTokenResponse>> refreshToken(@RequestBody RefreshTokenRequest request)
      ...
      return buildSuccessResponse("Refresh Token Method" , authenticationService.refreshToken(request));
  }
  ...
  public ResponseEntity<ApiResponse<ResetPasswordResponse>> resetPasswordEmail(
      ...
      return buildSuccessResponse("Reset Password Method" , authenticationService.resetPasswordEmail(request));
  }
}
