...
@Tag(name = "User Controller", description = "Manage users: create, update, delete, search, assign roles")
public class UserController {

  private final UserService userService;

  @Operation(summary = "Create a new user", description = "Register a new user with basic information")
  @PostMapping("/create")
  public ResponseEntity<ApiResponse<UserResponse>> create(@RequestBody UserCreationRequest request) {
  ...
  @Operation(summary = "Assign role to user", description = "Assign a role to a user by ID and role name")
  ...
  @Operation(summary = "Change password", description = "Update user's password by providing old and new password")
  @PutMapping("/change-password/{id}")
  public ResponseEntity<ApiResponse<UserResponse>> updateUserPassword(@PathVariable String id, @RequestParam String oldPassword, @RequestParam String newPassword) {
    return ResponseEntity.ok(ApiResponse.<UserResponse>builder()
                                        .status(1)
